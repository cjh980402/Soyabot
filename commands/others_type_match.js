const stringList = [
    ...
    "양반은 얼어 죽어도 짚불은 안 쬔다.",
    "양지가 음지 되고 음지가 양지 된다.",
    "언덕에 자빠진 돼지가 평지에 자빠진 돼지를 나무란다   해 다르고 애해 다르다.",
    ...
    "자식은 제 자식이 고와 보이고 곡식은 남의 곡식이 탐스러워 보인다.",
    ...
    "아이 싸움이 어른 싸움 된다.",
    "새도 염불을 하고 쥐도 방귀를 뀐다.",
    "전 오 리 밥 먹고 한 푼 모자라 치사를 백 번이나 한다.",
    "입에 쓴 약이 병에는 좋다.",
    "입은 비뚤어져도 말은 바로 하랬다.",
    "자라 보고 놀란 놈 소댕보고 놀란다.",
    ...
    "한 사이는 바늘 귀도 넓고, 친하지 않은 사이는 세계도 좁다.",
    ...
    "나귀는 샌님만 섬긴다.",
    "나귀에 짐을 지고 타나 싣고 타나",
    "그네 모양 보아 표주박에 밥을 담고 주인 모양 보아 손으로 밥먹는다.",
    "나루 건너 배 타기",
    "노처녀가 시집을 가려니 등창이 난다.",
    "눈감으면 코 베어먹을 세상",
