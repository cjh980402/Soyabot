const faceList = {
    남: ['차분한 루시드 얼굴', '개구쟁이 얼굴', '순둥이 얼굴', '이슬눈 얼굴', '꿈나라 얼굴', '뒤끝있는 얼굴'],
    여: ['차분한 루시드 얼굴', '조용한 눈 얼굴', '순둥이 얼굴', '이슬눈 얼굴', '꿈나라 얼굴', '사연있는 얼굴']
    ...
    interaction: {
        ...
        options: [
            ...
            },
            {
                ...
                choices: [...faceList['남'], ...faceList['여']].deduplication().map((v) => ({ name: v, value: v }))
            }
        ]
    },
