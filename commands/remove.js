...
module.exports = {
    ...
    execute(message, args) {
        ...
        if (!args.length) return message.reply(`사용법 : ${message.client.prefix}remove <Queue Number>`);
        if (isNaN(args[0])) return message.reply(`사용법 : ${message.client.prefix}remove <Queue Number>`);
