...
module.exports = {
    ...
    async execute(message) {
        ...
        const $ = load(await (await fetch('https://m.search.daum.net/search?w=tot&nil_mtopsearch=btn&DA=YZR&q=%EB%AF%B8%EC%84%B8%EB%A8%BC%EC%A7%80')).text());
        ...
        return message.channel.send(dustTitle, { files: [imgLink] });
    }
};
